...
old = '''                round_count = sum(1 for a in amounts if a % 10000 == 0)'''
new = '''                # Round to nearest 1,000 rather than 10,000 — real shell company
...
with open(path_gi, "w") as f:
    f.write(content)
print("Shell round-amount check widened to nearest 1,000.")
